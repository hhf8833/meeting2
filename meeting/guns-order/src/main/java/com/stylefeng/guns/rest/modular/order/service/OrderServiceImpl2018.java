...
class OrderServiceImpl2018 implements OrderServiceAPI {
    ...
    public String getSoldSeatsByFildId(Integer fieldId) {
        if (fieldId ==null){
            ...
            String soldSeatsByFildId = moocOrder2018TMapper.getSoldSeatsByFildId(fieldId);
    ...
    public boolean paySuccess(String orderId) {
        ...
        Integer update = moocOrder2018TMapper.updateById(moocOrderT);
        log.info("数据库修改值{},{}",update,moocOrderT.getOrderStatus());
        if (update>=1){
            return true;
        }
        return false;
